...
const CreatePavingBlock = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const { data } = await Api.api.post(Api.END_POINTS.CREATEPAVINGBLOCK, formData, {
        headers: {
        ...
        <form onSubmit={handleSubmit(onSubmit)} encType='multipart/form-data'>
          <div className='mb-4'>
            <input
              ...
              placeholder='Paving Block Title'
...
export default CreatePavingBlock;
